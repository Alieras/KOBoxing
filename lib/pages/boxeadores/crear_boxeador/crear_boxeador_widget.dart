...
import 'crear_boxeador_model.dart';
export 'crear_boxeador_model.dart';

class CrearBoxeadorWidget extends StatefulWidget {
  const CrearBoxeadorWidget({super.key});

  static String routeName = 'crearBoxeador';
  static String routePath = '/crearBoxeador';

  @override
  State<CrearBoxeadorWidget> createState() => _CrearBoxeadorWidgetState();
}

class _CrearBoxeadorWidgetState extends State<CrearBoxeadorWidget> {
  late CrearBoxeadorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CrearBoxeadorModel());
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      onFieldSubmitted: (_) async {
                                        _model.apiResultCedula =
                                            await CedulasCall.call(
                                          cedula: _model.textController1.text,
                                        );

                                        if ((_model
                                                .apiResultCedula?.succeeded ??
                                            true)) {
                                          safeSetState(() {
                                          ...
                                          ScaffoldMessenger.of(context)
                                            ...
                                            SnackBar(
                                              content: Text(
                                                'No se ha encontradi una persona con ese número de cédula',
                                                style: TextStyle(
                                      ...
                                      decoration: InputDecoration(
                                        hintText: 'Digite el número de cédula',
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      onChanged: (_) => EasyDebounce.debounce(
                                        '_model.textFieldApellidoTextController',
                                        Duration(milliseconds: 2000),
                                        () => safeSetState(() {}),
                                      ),
                                      autofocus: false,
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                await BoxeadoresRecord.collection
                                    .doc()
                                    .set(createBoxeadoresRecordData(
                                      nombre: _model
                                      ...
                                      telefono: _model.textController9.text,
                                      contactoEmergencia:
                                          _model.textController10.text,
                                      direccion: _model.textController6.text,
                                      activo: true,
                                      fechaRegistro: getCurrentTimestamp,
                                      sexo: _model.choiceChipsValue,
                                      telefonoEmergencia:
                                          _model.textController11.text,
                                      altura: _model.textController8.text,
                                      apodo:
                                          _model.textFieldTextController.text,
                                      cedula: _model.textController1.text,
                                    ));

                                await PesosInicialesRecord.collection
                                    .doc()
                                    .set(createPesosInicialesRecordData(
                                      nombre: _model
                                          .textFieldNombreTextController.text,
                                      apellido: _model
                                          .textFieldApellidoTextController.text,
