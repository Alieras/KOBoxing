...
import 'boxeadores_model.dart';
export 'boxeadores_model.dart';

class BoxeadoresWidget extends StatefulWidget {
  const BoxeadoresWidget({super.key});

  static String routeName = 'Boxeadores';
  static String routePath = '/boxeadores';

  @override
  State<BoxeadoresWidget> createState() => _BoxeadoresWidgetState();
}

class _BoxeadoresWidgetState extends State<BoxeadoresWidget> {
  late BoxeadoresModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BoxeadoresModel());
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  context.pushNamed(
                                    BoxeadoresInactivosWidget.routeName,
