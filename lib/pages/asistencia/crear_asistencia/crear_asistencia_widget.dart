...
class CrearAsistenciaWidget extends StatefulWidget {
  ...
  static String routeName = 'crearAsistencia';
  static String routePath = '/crearAsistencia';
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          top: true,
          child: Container(
            width: MediaQuery.sizeOf(context).width * 1.339,
            ...
            child: Column(
              ...
              children: [
                Column(
                  ...
                  children: [
                    Container(
                      width: MediaQuery.sizeOf(context).width * 1.344,
                      decoration: BoxDecoration(
                                  ...
                                  StreamBuilder<List<BoxeadoresRecord>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      return ListView.builder(
                                        ...
                                        itemCount:
                                            listViewBoxeadoresRecordList.length,
                                                          ...
                                                          children: [
                                                            ...
                                                            Theme(
                                                              ...
                                                              child: Checkbox(
                                                                value: _model
                                                                        .checkboxValueMap[
                                                                    listViewBoxeadoresRecord] ??= false,
                                                                onChanged:
                                                                    (newValue) async {
                                                                  safeSetState(() =>
                                                                      _model.checkboxValueMap[
                                                                              listViewBoxeadoresRecord] =
                                                                          newValue!);
                                                                },
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        FFButtonWidget(
                                          onPressed: () async {
                                            await AsistenciaRecord.collection
                                                .doc()
                                                .set({
